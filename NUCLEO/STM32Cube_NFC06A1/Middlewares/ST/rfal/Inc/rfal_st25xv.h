...
/*!
 *****************************************************************************
 * Function Name: NFC-V Poller Write Password
 * Date: 07/07/2022
 * Author: Paul E. Fritzen
 * Description: Sends the Write Password command. Returns either an error code
 * 				or No Error
 *
 * Input Parameters:
 * 	flags : Flags to be used: Sub-carrier; Data_rate; Option for NFC-Forum use:
 * 			 RFAL_NFCV_REQ_FLAG_DEFAULT
 *  uid   : UID of the device to be put to be read if not provided Select mode
 *  		 will be used
 *  pwdNum: Password ID number, can be 0-3
 *  pwd   : Password to be written
 *  pwdLen: The length of the Password to be written
 *
 * Returns:
 ...
 *  ERR_NONE       : No error, Write Successful
 *****************************************************************************
 */
