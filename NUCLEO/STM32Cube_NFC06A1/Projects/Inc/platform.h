...
* Description        : Platform header file. Defining platform independent
* 						functionality. This should contain all platform & hardware
* 						specifics such as GPIO assignment, system resources, locks,
* 						IRQs, etc.. Each distinct platform/system/board must
* 						provide this definitions for all SW layers to use
**********************************************************************************
* Attention!
*
